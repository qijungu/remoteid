...
#include <generic/param.h>
			...
			const bigint_t BN_INV_CONST = {0x00180191, 0x43000000, 0x00000002, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000};
	            ...
	            const ecpoint_fp ECFP_GENERATOR = {{0x9DD3CB65, 0x0111764E, 0x2B8820B9, 0xECEE535F, 0xAC1D764A, 0x049FA394, 0xBFE123D7, 0x45EC613D},
	                    {0x26849DD1, 0XFCCB9D14, 0X7D679DD4, 0X393505E2, 0XFBA79D1F, 0XF2211541, 0XC05C947A, 0X2E3ADC46},
	                    0};

	            const ecpoint_fp2 ECFP2_GENERATOR = {{{0x63659E67, 0xAF45AAAF, 0x3D01BC7C, 0xBB92F023, 0xDCD46337, 0xEF7AB941, 0x61DF5B55, 0x173F71DE},
	            {0xD0D2F4E7, 0x389BBB43, 0xBC087B6A, 0x413D1E26, 0x7A42E357, 0x1FCE9382, 0x6630C4E9, 0x10C76BD0}},
	             {{0xE9EF48BB, 0xEF52EA4D, 0x5CDE8E4D, 0xBC89BB84, 0xA193799C, 0x23EB728D, 0xE9D155DC, 0x3E8C5054},
	            {0xE7F23FCE, 0xA4E2E43C, 0xD21F5C81, 0xA66E7BF0, 0x9D835CB2, 0x0F29ED15, 0x0CC5EAE9, 0xB2E74B62}},
	            0};
