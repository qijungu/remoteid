 ...
 */
int ecfp_get_y(fp_t res, const fp_t x) {
	fp_t r1;
	...
	return ecfp_verify_coordinates(x, res);
}
 ...
 * @return   0 if y exists, otherwise 1.
 */
int ecfp_get_point(ecpoint_fp* res, const fp_t x) {
    fp_t y;
    int v = ecfp_get_y(y, x);
 ...
 */
int ecfp_compare_std(ecpoint_fp *a, const ecpoint_fp *b) {
