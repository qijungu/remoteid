...
typedef struct {
    // public as in paper
    bigint_t p;     // private p, PRIME_P
    bigint_t n;     // group order, EC_PARAM_N
    ecpoint_fp P;   // generator of G1, ECFP_GENERATOR
    ecpoint_fp2 Q;  // generator of G2, ECFP2_GENERATOR
    ecpoint_fp2 Kq; // public key
